...
def test_codex_emits_chat_usage_chunk_with_cache_and_reasoning_tokens():
    """Codex usage is mapped to Chat Completions fields Cursor can consume."""
    messages = _messages(
        _sse(
            "response.completed",
            {
